...
| RV32I Single Cycle CPU | Implemented Single-cycle RV32I CPU based on RISC-V ISA | `SystemVerilog`, `RISC-V`, `CPU Design`, `Computer Architecture` | [Link](https://github.com/subb-2/riscv-rv32i-singlecycle-rtl-simulation.git) |
